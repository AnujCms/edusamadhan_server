...
const profileObject = middleWare(joiSchema.profileObject, "body", true);
...
router.post("/updateProfileDetails", isStudent, profileObject, async (req, res) => {
    try {
...
router.get("/studentfeedetails/:adharnumber", isStudent, adharNumberParams, async function (req, res) {
