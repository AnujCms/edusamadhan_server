...
function configRouter() {
    ...
    router.use("/publiccontent", require('../api/PublicContent.js'));
    ...
    router.use("/directorservice",isAuthenticated, require("../api/DirectorService.js"));
    router.use("/principalservice",isAuthenticated, require("../api/PrincipalService.js"));
    router.use("/managerservice",isAuthenticated, require("../api/ManagerService.js"));
    router.use("/teacherservice",isAuthenticated, require("../api/TeacherService.js"));
    router.use("/examinationservice",isAuthenticated, require("../api/ExaminationService.js"));
    router.use("/accountantservice",isAuthenticated, require("../api/AccountantService.js"));
